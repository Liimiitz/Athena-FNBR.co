...
class Athena:
    ...
    def main(self):
        ...
        print("https://github.com/Liimiitz/Athena-FNBR.co\n")
        ...
        if initialized is True:
            ...
            itemShop = Utility.GET(self,"https://fnbr.co/api/shop",{"x-api-key": self.apiKey})
    ...
    def GenerateCard(self, item: dict):
        ...
        if rarity == "frozen":
            ...
            rarity = "DC"
        elif rarity == "icon_series":
            blendColor = (54, 183, 183)
            rarity = "Icon"
        elif rarity == "shadow":
            blendColor = (113, 113, 113)
            rarity = "Shadow"
        elif rarity == "gaming_legends":
